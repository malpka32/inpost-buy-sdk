...
[![CI](https://github.com/malpka32/inpost-buy-sdk/actions/workflows/ci.yml/badge.svg)](https://github.com/malpka32/inpost-buy-sdk/actions/workflows/ci.yml)
...
[![Code style: PSR-12](https://img.shields.io/badge/code%20style-PSR--12-1a1a2e.svg)](https://www.php-fig.org/psr/psr-12/)
[![Packagist Version](https://img.shields.io/packagist/v/malpka32/inpost-buy-sdk)](https://packagist.org/packages/malpka32/inpost-buy-sdk)
[![Maintained](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/malpka32/inpost-buy-sdk/graphs/commit-activity)
...
CI runs on push/PR (PHP 8.1–8.3): code style (PSR-12), PHPStan, tests with coverage. See [Actions](https://github.com/malpka32/inpost-buy-sdk/actions).
...
This project is **actively maintained**: we keep it in sync with InPost API changes and welcome issues and pull requests on [GitHub](https://github.com/malpka32/inpost-buy-sdk).
